...
urlpatterns = [
    ...
    url(r'^(?P<school_id>\d+)/kennari/$',
        TeacherListing.as_view(),
        name='teacher_listing'),
    url(r'^kennari/(?P<pk>\d+)/$',
        TeacherOverview.as_view(),
        name='teacher_overview'),
    url(r'^(?P<school_id>\d+)/kennari/(?P<pk>\d+)/$',
        TeacherDetail.as_view(),
        name='teacher_detail'),
    url(r'^(?P<school_id>\d+)/kennari/create/$',
        TeacherCreate.as_view(),
        name='teacher_create'),
    url(r'^(?P<school_id>\d+)/kennari/create/import$',
        TeacherCreateImport.as_view(),
        name='teacher_create_import'),
    url(r'^(?P<school_id>\d+)/kennari/(?P<pk>\d+)/update/$',
        TeacherUpdate.as_view(),
        name='teacher_update'),
    url(r'^(?P<school_id>\d+)/kennari/(?P<pk>\d+)/delete/$',
        TeacherDelete.as_view(),
        name='teacher_delete'),

    url(r'^(?P<school_id>\d+)/próf/$',
        SurveyListing.as_view(),
        name='survey_listing'),
    url(r'^(?P<school_id>\d+)/próf/(?P<pk>\d+)/$',
        SurveyDetail.as_view(),
        name='survey_detail'),
    url(r'^(?P<school_id>\d+)/próf/(?P<pk>\d+)/update/$',
        SurveyUpdate.as_view(),
        name='survey_update'),
    url(r'^(?P<school_id>\d+)/próf/(?P<pk>\d+)/delete/$',
        SurveyDelete.as_view(),
        name='survey_delete'),

    url(r'^lykilorð/$',
        SurveyLoginAdminListing.as_view(),
        name='survey_login_admin_listing'),
    url(r'^lykilorð/(?P<survey_id>[\w ]+)$',
        SurveyLoginDetail.as_view(),
