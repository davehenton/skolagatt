...
urlpatterns = [
    ...
    url(r'^(?P<school_id>\d+)/prófadæmi/(?P<groupsurvey_id>\d+)/nemandi/(?P<student_id>\d+)/(?P<quiz_type>[\w ]+)/$',
        views.ExampleSurveyDetail.as_view(),
        name='example_survey_detail'),
    ...
    url(r'^prófadæmi/spurningar/import/$',
        views.ExampleSurveyQuestionAdminImport.as_view(),
        name='example_survey_question_admin_import'),
    ...
    url(r'prófadæmi/svör/create/$',
        views.ExampleSurveyAnswerAdminCreate.as_view(),
        name='example_survey_answer_admin_create'),
