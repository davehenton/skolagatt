...
class SurveyCreate(common_mixins.SchoolEmployeeMixin, CreateView):
    ...
    def get_form(self):
        ...
        survey_set = Survey.objects.filter(
            ...
            groupsurvey__in=GroupSurvey.objects.filter(studentgroup_id=self.kwargs['student_group'])
        )
...
class ExampleSurveyQuestionAdminListing(common_mixins.SuperUserMixin, ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['quiz_types'] = ExampleSurveyQuestion.objects.values_list('quiz_type', flat=True).distinct()
        return context
