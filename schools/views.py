...
class SchoolDetail(SchoolEmployeeMixin, DetailView):
  ...
  def get_context_data(self, **kwargs):
    ...
    context['surveys']           = slug_sort(Survey.objects.filter(
...
class TeacherDetail(SchoolEmployeeMixin, DetailView):
  ...
  def get_context_data(self, **kwargs):
    ...
    context['school'] = School.objects.get(pk=self.kwargs['school_id'])
    context['groups'] = slug_sort(StudentGroup.objects.filter(
...
class StudentListing(SchoolEmployeeMixin, ListView):
  ...
  def get_context_data(self, **kwargs):
    ...
    context['students_outside_groups'] = slug_sort(Student.objects.filter(school=school).exclude(
...
class SurveyListing(SchoolEmployeeMixin, ListView):
  ...
  def get_context_data(self, **kwargs):
    ...
    school                        = School.objects.get(pk=self.kwargs['school_id'])
    context['surveylisting_list'] = slug_sort(Survey.objects.filter(
