...
urlpatterns = [
	...
	url(r'^stæ/$',
		SamraemdMathResultAdminListing.as_view(),
		name='math_admin_listing'),
	url(r'^stæ/(?P<school_id>\d+)/$',
		SamraemdMathResultListing.as_view(),
		name='math_listing'),
	url(r'^stæ/niðurstöður/create/$',
		SamraemdMathResultCreate.as_view(),
		name='math_create'),
	url(r'^stæ/niðurstöður/(?P<exam_code>[\w ]+)/delete/$',
		SamraemdMathResultDelete.as_view(),
		name='math_delete'),
	url(r'^isl/$',
		SamraemdISLResultAdminListing.as_view(),
		name='isl_admin_listing'),
	url(r'^isl/(?P<school_id>\d+)/$',
		SamraemdISLResultListing.as_view(),
		name='isl_listing'),
	url(r'^isl/niðurstöður/create/$',
		SamraemdISLResultCreate.as_view(),
		name='isl_create'),
	url(r'^niðurstöður/rawdata/$',
		RawDataCreate.as_view(),
		name='rawdatacreate'),
	url(r'^isl/niðurstöður/(?P<exam_code>[\w ]+)/delete/$',
		SamraemdISLResultDelete.as_view(),
		name='isl_delete'),
	url(r'^niðurstöður/(?P<exam_code>[\w ]+)/(?P<year>\d+)/(?P<group>\d+)/delete/$',
		SamraemdResultDelete.as_view(),
		name='raw_delete'),
