...
urlpatterns = [
    ...
    url(r'^niðurstöður/(?P<school_id>\d+)$',
        ...
        name='result_list'),
    url(r'^niðurstöður/(?P<school_id>\d+)/excel/$',
        views.excel_for_principals,
        name='excel_for_principals'),
    ...
    url(r'^niðurstöður/(?P<school_id>\d+)/(?P<year>\d+)/(?P<group>\d+)/einkunnablod/$',
        views.SamraemdResultDetail.as_view(),
        name='result_print'),
    url(r'^niðurstöður/(?P<school_id>\d+)/(?P<year>\d+)/(?P<group>\d+)/bekkur/(?P<studentgroup_id>\d+)/einkunnablod/$',
        views.SamraemdResultDetail.as_view(),
        name='result_print_studentgroup'),
    url(r'^niðurstöður/(?P<school_id>\d+)/(?P<year>\d+)/(?P<group>\d+)/nemandi/(?P<student_id>\d+)/einkunnablod/$',
        views.SamraemdResultDetail.as_view(),
