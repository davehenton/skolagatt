...
def get_schools(context):
	user = context['request'].user
	manager_schools = School.objects.filter(manager__ssn=user.username)
	teacher_schools = School.objects.filter(teacher__ssn=user.username)
